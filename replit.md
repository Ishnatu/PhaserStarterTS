...
- **Blacksmith's Forge Menu**: 900px wide panel with fixed 3-column grid layout. Both Enhancement and Repair tabs use identical column anchors for clean vertical alignment: Column 1 (item names) at width/2 - 420 (~420px width), Column 2 (enhancement/durability values) at width/2 (~150px width), Column 3 ([Select] buttons) at width/2 + 150. This Phaser-based grid system ensures all rows align vertically regardless of item name length, preventing overlap while maintaining visual clarity.
