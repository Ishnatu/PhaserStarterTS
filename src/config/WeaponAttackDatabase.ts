  ...
  private static weaponAttacks: Map<WeaponType | ShieldType, WeaponAttack[]> = new Map([
    ...
    ['mace', [
      ...
      },
      {
        ...
        conditionChance: 65,
        conditionDuration: 2,
        specialEffect: 'On stun: deal additional 1d12 damage and reduce target armor by 3 for 2 rounds, dual-wield only',
        availableWithShield: false,
        requiresDualWield: true,
      },
    ]],
    ...
    ['spear', [
      ...
      },
      {
        ...
        conditionChance: 55,
        conditionDuration: 3,
        specialEffect: 'Strikes 4 times, if target already poisoned double poison damage for duration, dual-wield only',
        availableWithShield: false,
        requiresDualWield: true,
      },
    ]],
