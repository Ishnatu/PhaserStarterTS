...
export class MainMenuScene extends Phaser.Scene {
  ...
  preload() {
    ...
    // Preload all NPC icons for TownScene (with cache-busting)
    ...
    this.load.image('marketplace-icon', `/assets/npcs/marketplace-icon.png${cacheBust}`);
    this.load.image('vault-keeper-icon', `/assets/npcs/vault-keeper-icon.png${cacheBust}`);
    this.load.image('keeper-of-virtue-icon', `/assets/npcs/keeper-of-virtue-icon.png${cacheBust}`);
  }
